...
apk add --cache-packages sudo python3 openssh openrc xorg-server xf86-video-modesetting xf86-input-libinput mesa-dri-gallium mesa-egl xfce4 xterm xdotool font-dejavu firefox dbus dbus-x11 udev eudev xinit
